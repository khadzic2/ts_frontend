...
const CartItem = ({ cart }) => {
    return (
        <>
        {cart.map((product) => (
            <div key={product.id} className='flex justify-between mb-6 pb-6 border-b-2 border-gray-200 text-primary'>
                <div className='flex flex-2'>
                    {/*<img src={product.images[0].image} alt="" className='w-[200px] h-[150px] object-contain' />*/}
                    <img src={admin} alt="" className='w-[200px] h-[150px] object-contain' />
                ...
                <div className='flex flex-col ml-auto'>
                    ...
                    <div className='w-[150px] text-center mt-auto ml-auto'>
                        <span className='text-secondary-100 font-bold italic'>{product.totalPrice}</span>
                    </div>
                </div>
                <hr className='my-4' />
            </div>
